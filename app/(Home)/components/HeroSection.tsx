    ...
    return (
        <section className="relative flex min-h-screen flex-col justify-center px-6 py-20 md:px-12 lg:px-20">
            <div className="mx-auto w-full max-w-6xl">
                <div className={`mb-8 transition-all duration-700 ease-out ${isVisible ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0"
                    }`}
                >
                    <span className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-[rgb(25,25,25)] px-4 py-2 text-sm text-white/60"><span className="h-2 w-2 animate-pulse rounded-full bg-[#22c55e]" />Available for web projects</span>
                </div>

                <h1 className={`mb-6 text-[clamp(2.5rem,8vw,6rem)] font-bold leading-[0.95] tracking-tight text-white transition-all delay-100 duration-700 ease-out ${isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
                    }`}
                >
                ...
                <p className={`text-justify mb-12 max-w-xl text-lg leading-relaxed text-white/60 transition-all delay-200 duration-700 ease-out md:text-xl ${isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
                    }`}
                >
                    Junior Web Developer passionate about creating clear and functional digital experiences. Currently seeking my first professional opportunity to grow and refine my skills.
                </p>
